...
const loophole = setInterval(() => {
  try {
    if (document.querySelector(".toast-root").dataset.state) {
      ...
      if (document.querySelector(".toast-root").innerHTML === "") clearInterval(loophole);
    }
  } catch { }
}, 0);
...
setInterval(() => {
  try {
    ...
    if (document.querySelector(".text-4xl").innerHTML !== `<a href="https://t.me/NimDev" class="text-4xl font-semibold text-center mt-6 sm:mt-[20vh] ml-auto mr-auto mb-10 sm:mb-16 flex gap-2 items-center justify-center">ChatGPT</a>`) document.querySelector(".text-4xl").innerHTML = `<a href="https://t.me/NimDev" class="text-4xl font-semibold text-center mt-6 sm:mt-[20vh] ml-auto mr-auto mb-10 sm:mb-16 flex gap-2 items-center justify-center">ChatGPT</a>`
